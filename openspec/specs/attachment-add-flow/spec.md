...
Defines the user-facing flows for adding file attachments to vault items — single-file picker, batch drag-and-drop, confirmation sheets, upload progress, and cancellation.

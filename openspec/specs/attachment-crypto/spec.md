...
Defines the cryptographic requirements for file attachment encryption — per-attachment key generation, AES-256-CBC + HMAC-SHA256 encryption, key wrapping, known-answer tests, and key zeroing.
